									...
									<div className="col-lg-6">
										<div className="slider-content">
											...
											<ul className="slider-btn rounded-buttons">
												...
												<li>
													<a className="main-btn rounded-two" href="#">
														DOWNLOAD
													</a>
												</li>
											</ul>
					...
					<div className="row justify-content-center">
						<div className="col-lg-6 col-md-10">
							<div className="section-title text-center pb-10">
								...
								<p className="text">
									Stop wasting time and money designing and managing a website that doesn’t get
						...
						<div className="col-lg-4 col-md-7 col-sm-9">
							<div className="single-features mt-40">
								...
								<div className="features-content">
									<p className="text">
										Short description for the ones who look for something new. Short description for
										the ones who look for something new.
									</p>
									<a className="features-btn" href="#">
										LEARN MORE
									</a>
								</div>
							</div>{' '}
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/1.png">
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/2.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/3.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/4.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/5.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/6.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/7.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/8.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
									...
									<div className="single-portfolio">
										<div className="portfolio-image">
											...
											<div className="portfolio-overlay d-flex align-items-center justify-content-center">
												<div className="portfolio-content">
													<div className="portfolio-icon">
														<a className="image-popup" href="assets/images/portfolio/9.png">
															<i className="lni lni-zoom-in" />
														</a>
														<img
															src="assets/images/portfolio/shape.svg"
						...
						<div className="col-lg-4 col-md-7 col-sm-9">
							<div className="pricing-style mt-30">
								...
								<div className="pricing-list">
									<ul>
										<li>
											<i className="lni lni-check-mark-circle" /> Carefully crafted components
										</li>
										<li>
											<i className="lni lni-check-mark-circle" /> Amazing page examples
										</li>
									</ul>
								</div>
										...
										<div className="card">
											...
											>
												<div className="card-body">
													<p className="text">
														Morbi vehicula arcu et pellentesque tincidunt. Nunc ligula
														nulla, lobortis a elementum non, vulputate ut arcu. Aliquam erat
														volutpat. Nullam lacinia felis.
													</p>
												</div>
											</div>
										</div>{' '}
					...
					<div className="row justify-content-between">
						<div className="col-xl-5 col-lg-6">
							<div className="testimonial-left-content mt-45">
								...
								<p className="text">
									Duis et metus et massa tempus lacinia. Class aptent taciti sociosqu ad litora
									torquent per conubia nostra, per inceptos himenaeos. Maecenas ultricies, orci
									molestie blandit interdum. <br /> <br /> ipsum ante pellentesque nisl, eget mollis
									...
									<div className="single-testimonial">
										<div className="testimonial-text">
											<p className="text">
												...
												nisl, sit amet convallis nunc turp.”
											</p>
										</div>
							...
							<div className="col-lg-4 col-md-6">
								<div className="single-contact-info contact-color-1 mt-30 d-flex ">
									...
									<div className="contact-info-content media-body">
										<p className="text">
											{' '}
											Elizabeth St, Melbourne<br />1202 Australia.
										</p>
									</div>
								</div>{' '}
								{/* single contact info */}
						...
						<div className="col-lg-12">
							<div className="contact-wrapper form-style-two pt-115">
								<h4 className="contact-title pb-10">
									<i className="lni lni-envelope" /> Leave <span>A Message.</span>
								</h4>
						...
						<div className="col-lg-6">
							...
							<div className="copyright text-center mt-35">
								<p className="text">
									...
									and Built-with{' '}
									<a rel="nofollow" href="https://ayroui.com">
										Ayro UI
									</a>{' '}
								</p>
							</div>{' '}
